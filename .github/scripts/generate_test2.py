...
3. Generates tests using the OpenRouter API with Google Gemini 2.0 Flash model
...
"""
    ...
    def _call_ai(self, prompt: str) -> str:
        """Call the OpenRouter API with the prompt and return the generated code."""
        try:
            ...
            headers = {
                ...
                "X-Title": "Test Generator"  # Optional, shows in OpenRouter logs
            }
            ...
            response = requests.post(
                ...
                headers=headers,
                json=payload,
                timeout=120  # Allow up to 2 minutes for the API to respond
            )
